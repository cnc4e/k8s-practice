...
[3]:https://kubernetes.io/ja/docs/reference/kubectl/
...
[4]:https://kubernetes.io/ja/docs/tasks/tools/
...
Podが正常起動しないなど、トラブルシュートの際に使用します。
...
また`kubectl exec`を使用して、指定したPodの中に入る（正確には実行中のコンテナへのシェルを取得する）ことができます。  
