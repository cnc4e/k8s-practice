...
JobもPodコントローラの一種ですが、少し異なり、`一度だけの処理を実行させること`を目的としたPodコントローラです。
...
2. STATUS:Errorになっている3つのPodのログを表示する。3つとも"Backup sippai..."が表示されることを確認してください。

3. Jobリソースのオブジェクト一覧を表示し、COMPLETIONSが0/1になっていることを確認してください。
